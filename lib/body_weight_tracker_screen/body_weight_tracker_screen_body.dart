  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ScrollableDateBar(
            //rebuilds the scrollable date bar when the date range changes.
          ...
          Padding(
            ...
            child: ConstrainedBox(
              ...
              child: Row(
                // contains target and highlighted weight records date and weight.
                  ...
                  Column(
                    children: [
                      ...
                      Selector<BodyWeightTrackerProvider,
                          ...
                          //rebuild when highlighted date point changes.
              ...
              child: ConstrainedBox(
                ...
                child: Selector<BodyWeightTrackerProvider, bool>(
                    ...
                    builder: (context, _, __) {
                      ///The body weight tracker rebuilds and fetches data again when the refreshDataFlag changes.
                      ///This happens when user scrolls the date bar and changes the date range.
                      ///The tracker is only built when the data has been fetched from the database.
                            ...
                            if (snapshot.hasError) {
                              ...
                              return Selector<BodyWeightTrackerProvider, bool>(
                                ...
                                builder: (context, _, __) {
                                  ...
                                  ///The happens when user adds new weight record to a date that is contained within the date range.
