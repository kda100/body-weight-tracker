...
///Interactive chart display users weight records and target.
    ...
    return charts.TimeSeriesChart(
          ...
          changedListener: (charts.SelectionModel model) {
            ...
            if (selectedDatum.isNotEmpty) {
              if (selectedDatum.first.series.id != "Target" &&
                ...
                // removes highlighted point if invalid point is selected.
      ...
      primaryMeasureAxis: charts.NumericAxisSpec(
        ...
        viewport: charts.NumericExtents(
          //creates default y-axis limits in cases where no weight record data is available and it is is.
          bodyWeightTrackerProvider.weightPointsLen > 0 ||
                  bodyWeightTrackerProvider.targetPointsLen > 0
