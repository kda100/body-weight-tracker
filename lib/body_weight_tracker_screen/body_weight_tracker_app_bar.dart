import 'package:body_weight_tracker/alert_dialogs/actionable_alert_dialog.dart';
import 'package:body_weight_tracker/alert_dialogs/dismissible_alert_dialog.dart';
          ...
          onSelected: (item) async {
            switch (item) {
              ...
              case MenuItem.setNewTarget:
                ...
                if (target != null) {
                  final BodyWeightAndStrengthTrackerUpdateStatus updateStatus =
