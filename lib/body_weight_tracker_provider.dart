...
class BodyWeightTrackerProvider with ChangeNotifier {
  DocumentReference? _targetDocRef =
      FirebaseFirestore.instance.doc("Your Target Document Reference");
  CollectionReference? _weightRecordsColRef = FirebaseFirestore.instance
      .collection("Your Weight Records Collection Reference");
  ...
  Future<BodyWeightTrackerUpdateStatus> deleteHighlightedDataPoint() async {
