...
enum BodyWeightAndStrengthTrackerUpdateStatus {
  OVERWRITE,
  SUCCESS,
  ERROR,
}
...
class BodyWeightTrackerProvider with ChangeNotifier {
  ...
  Future<BodyWeightAndStrengthTrackerUpdateStatus> verifyNewWeightRecord(
    ...
    try {
      ...
      return BodyWeightAndStrengthTrackerUpdateStatus.ERROR;
    }
    if (queryDocSnapshot != null && queryDocSnapshot.length > 0) {
      _overwriteDocs = queryDocSnapshot;
      return BodyWeightAndStrengthTrackerUpdateStatus.OVERWRITE;
    }
    addWeightRecord(weightRecord: weightRecord);
    return BodyWeightAndStrengthTrackerUpdateStatus.SUCCESS;
  }

  Future<BodyWeightAndStrengthTrackerUpdateStatus> addAndDeleteWeightRecord(
      {required WeightRecord weightRecord}) async {
  ...
  Future<BodyWeightAndStrengthTrackerUpdateStatus> addWeightRecord({
  ...
  Future<BodyWeightAndStrengthTrackerUpdateStatus>
  ...
  Future<BodyWeightAndStrengthTrackerUpdateStatus> setNewTarget(
  ...
  Future<BodyWeightAndStrengthTrackerUpdateStatus> removeTarget() async {
    try {
