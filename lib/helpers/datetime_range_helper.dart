...
class DateTimeRangeHelper {
  /// gets the DateTimeRange object with the max and min DateTimes of the current quarter we are in DateTimeRange(01/01/2022, 31/03/2022)
  ...
  /// substracts a set number of months to the max and min DateTimes of a DateTimeRange Object. 
