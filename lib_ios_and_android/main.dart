          ...
          cupertino: (_, __) => CupertinoAppData(
            theme: CupertinoThemeData(
              ...
              textTheme: CupertinoTextThemeData(
                navActionTextStyle:
                    TextStyles.heading1.copyWith(fontSize: 14.sp),
                textStyle: TextStyles.bodyText1.copyWith(fontSize: 12.sp),
                navTitleTextStyle: TextStyles.heading2.copyWith(fontSize: 16),
                primaryColor: ColorPalette.primaryColor,
                actionTextStyle:
                    TextStyles.textButtonStyle.copyWith(fontSize: 12.sp),
                dateTimePickerTextStyle: TextStyles.bodyText1.copyWith(
                  fontSize: 14.sp,
                ),
              ),
            ),
          ...
          material: (_, __) => MaterialAppData(
            theme: ThemeData(
              ...
              popupMenuTheme: PopupMenuThemeData(
                ...
                elevation: 5,
                textStyle: TextStyles.bodyText1.copyWith(fontSize: 14.sp),
              ),
              textTheme: TextTheme(
                bodyText2: TextStyles.bodyText1.copyWith(fontSize: 14.sp),
              ),
              primaryColor: ColorPalette.primaryColor,
