          ...
          cupertino: (_, __) => CupertinoAppData(
            theme: CupertinoThemeData(
              ...
              textTheme: CupertinoTextThemeData(
                ...
                textStyle: TextStyles.customBodyText.copyWith(fontSize: 12),
                ...
                dateTimePickerTextStyle: TextStyles.customBodyText.copyWith(
                  fontSize: 14.sp,
                ),
              ),
            ),
          ...
          material: (_, __) => MaterialAppData(
            theme: ThemeData(
              ...
              popupMenuTheme: PopupMenuThemeData(
                ...
                elevation: 5,
                textStyle: TextStyles.customBodyText.copyWith(fontSize: 14.sp),
              ),
              textTheme: TextTheme(
                bodyText2: TextStyles.customBodyText.copyWith(fontSize: 14.sp),
              ),
              primaryColor: ColorPalette.primaryColor,
