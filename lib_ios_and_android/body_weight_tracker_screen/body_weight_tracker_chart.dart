    ...
    return charts.TimeSeriesChart(
      ...
      behaviors: [
        charts.SeriesLegend(
          ...
          cellPadding: EdgeInsets.symmetric(horizontal: 8.0),
        ),
      ...
      primaryMeasureAxis: charts.NumericAxisSpec(
        ...
        viewport: charts.NumericExtents(
          bodyWeightTrackerProvider.minWeightChartLimit,
          bodyWeightTrackerProvider.maxWeightChartLimit,
        ),
      ),
